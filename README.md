...
The raw data (country facts, images, geographic information) all come
from external sources and are not owned by Metrop :

- Wikipedia content and images : © Wikipedia contributors,
  licensed under CC BY-SA 4.0
  https://creativecommons.org/licenses/by-sa/4.0/

- GeoJSON URLs referenced in this data are not owned by Metrop,
  see "Geographic Data" section for their license.

What IS protected by Metrop copyright is exclusively :
the original structure, hierarchy, and organization of the JSON format.